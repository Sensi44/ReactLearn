...
// Желательно следить за примитивами, но если нужно функцию то читай отдельно,
// тут про это писать не стал
useEffect(() => {
...
// Полезная опция, очень! избавляет от лишних ререндеров в некоторых ситуациях
// https://www.youtube.com/watch?v=QQYeipc_cik - оч. правильное видео
useEffect(() => {
